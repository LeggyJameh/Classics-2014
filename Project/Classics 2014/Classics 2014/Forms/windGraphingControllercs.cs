...
namespace Classics_2014
{
     partial class windGraphingControllercs : UserControl
    {
        ...
        private void buttonUseEventSettings_Click(object sender, EventArgs e)
        {
            ...
            //    chartWind.ChartAreas[0].AxisY.StripLines[0].IntervalOffset = Event.Rules.windout;
            //    numericUpDownWindOverChartBar.Value = (decimal)(Event.Rules.windout);
            //    numericUpDownDirectionChangeGraphLimit.Value = Event.Rules.directionOut;
            //    ResetGraphColours();
            //}
            //else { 
            MessageBox.Show("No event suitable for transplanting rules.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        //}
